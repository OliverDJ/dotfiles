# GIT
GIT_NAME="Oliver Damsgaard Jensen"
GIT_EMAIL="oliver.damsgaard@gmail.com"
...
BREW_CASKS="android-studio appcleaner atom google-backup-and-sync basictex
  flux google-chrome intellij-idea iterm2 java jetbrains-toolbox postman
  pycharm r-app skype slack spectacle spotify torbrowser
...
# BREW (OPTIONAL)
OPTIONAL_BREW_PACKAGES="gnupg nmap nvm pyenv wget yarn"
